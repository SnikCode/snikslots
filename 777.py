...
ctypes.windll.kernel32.SetConsoleTitleA(b"SnikSlots | Snik1 | www.snikslots.org")
...
class Cash:
    ...
    def __init__(self, credit=100000, bet=2):
        """
        ...
        self.credit = credit
        self.bet = bet
        self.bets = [2, 5, 10, 20, 50, 100, 250, 500, 1000, 5000, 10000]
...
def layout(s1, s2, s3):
    ...
    print('\t|                                         |  |')
    print('\t|        SnikSlots - Лучшее Казино        |  |')
    print('\t|                       www.snikslots.org |  |')
